...
const TopCards:React.FC = () => {
    return (
        <div className="flex flex-col items-center m-4">
            <div className="w-[95%] h-[30%] pt-8 pb-8 pr-4 pl-4 bg-blob-scene bg-center bg-cover bg-no-repeat rounded-lg p-4 screen-375:bg-[#CDF7F6] screen-375:w-full screen-375:p-4 screen-375:pr-0 ">
