...
const IMCFunc = () => {
    ...
    return (
        <div className="dark:bg-[#1f1f1f]">
            <div className="flex items-center justify-center flex-col shadow-customized rounded-br-[20%] rounded-bl-[20%] dark:bg-[#303030] dark:text-[#fefdff]">
                <h1 className="font-Roboto_mono uppercase text-[#111111] m-2 dark:text-[#fefdff]">
                    imc
                </h1>
                <p>
                ...
                {show && (
                    <div className="flex items-center justify-center flex-col mb-2">
                        <ul className="font-sans text-[#111111] dark:text-[#fefdff]">
