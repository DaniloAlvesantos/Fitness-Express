                ...
                <div className="flex items-center justify-evenly w-[60%] mt-[3rem] mobile-sm:w-[80%]">
                    ...
                    <div className="flex justify-end absolute right-[5px] mb-[-4rem]">
                        <div className="flex items-center justify-center gap-4">
                            <button onClick={scroll} className="bg-[#1affd5] w-9 h-9 rounded-lg border-none p-[5px] mb-[-5rem] cursor-pointer flex justify-center items-center transition-colors duration-300 hover:bg-cyan-400 mobile-small:mr-10">
                                <img
